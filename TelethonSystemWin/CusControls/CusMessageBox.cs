 ...
 * Adapted from tutorial by RJ Code Advance EN: Create a Custom MessageBox - C#, Visual Basic (VB.NET) & WinForms / Modern Flat UI
 * https://www.youtube.com/watch?v=XWM0VnTXksY&t=111s
 */
...
{
    public abstract class CusMessageBox
    {
