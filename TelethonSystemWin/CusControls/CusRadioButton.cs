/**
 * Custom RadioButton WinForm Control
 * Adapted from tutorial by RJ Code Advance EN: Custom RadioButton - WinForm C#
 * https://www.youtube.com/watch?v=SAA5qDoiL4M
 */
...
namespace TelethonSystemWin.CusControls
{
    internal class CusRadioButton :RadioButton
    {
        ...
        public CusRadioButton()
        {
            ...
            //Add a padding of 10 to the left for a considerable distance between the text and the RadioButton.
